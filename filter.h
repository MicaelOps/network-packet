...
#define FILTER_FRIENDLY_NAME        L"network_packet NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{d94fa0ba-cfce-44ab-8e78-839d61de0b79}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"network_packet"
...
DRIVER_DISPATCH networkpacketDispatch;

DRIVER_DISPATCH networkpacketDeviceIoControl;
