...
#pragma NDIS_INIT_FUNCTION(networkpacketRegisterDevice)


_IRQL_requires_max_(PASSIVE_LEVEL)
NDIS_STATUS
networkpacketRegisterDevice(
    VOID
    )
{
    ...
    DEBUGP(DL_TRACE, "==>networkpacketRegisterDevice\n");
   
    
    NdisZeroMemory(DispatchTable, (IRP_MJ_MAXIMUM_FUNCTION+1) * sizeof(PDRIVER_DISPATCH));
    
    DispatchTable[IRP_MJ_CREATE] = networkpacketDispatch;
    DispatchTable[IRP_MJ_CLEANUP] = networkpacketDispatch;
    DispatchTable[IRP_MJ_CLOSE] = networkpacketDispatch;
    DispatchTable[IRP_MJ_DEVICE_CONTROL] = networkpacketDeviceIoControl;
    ...
    DEBUGP(DL_TRACE, "<==networkpacketRegisterDevice: %x\n", Status);
